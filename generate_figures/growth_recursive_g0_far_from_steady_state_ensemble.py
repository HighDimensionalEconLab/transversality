...
output_dir = "./figures"
plot_name = "growth_recursive_g0_far_from_steady_state_ensemble"
output_path = output_dir + "/" + plot_name + ".pdf"
tag = "growth_recursive_g0_far_from_steady_state_ensemble"
api = wandb.Api()
...
quant_extrapolation = quant_result_g0[(quant_result_g0["k_t_approx"][quantiles['mid_quant']] <= k_min) | (quant_result_g0["k_t_approx"][quantiles['mid_quant']] >= k_max)]
quant_interpolation = quant_result_g0[((quant_result_g0["k_t_approx"][quantiles['mid_quant']] >= k_min) & (quant_result_g0["k_t_approx"][quantiles['mid_quant']] <= k_max))]
...
plt.plot(quant_result_g0["k_t_approx"][quantiles['mid_quant']], "black", label=r"$\hat{k}(t)$")
...
plt.plot(quant_result_g0["c_t_approx"][quantiles['mid_quant']], "blue", label=r"$\hat{c}(t)$")
