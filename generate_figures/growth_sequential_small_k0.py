...
output_dir = "./figures"
plot_name = "growth_sequential_g0_small_k_0_one_run"
output_path = output_dir + "/" + plot_name + ".pdf"
tag = "growth_sequential_g0_small_k_0_one_run"
api = wandb.Api()
...
ylim_min = 0.5 * np.amin(np.minimum(k_sol, k_0))
ylim_max = 1.4 * np.amax(np.maximum(k_sol, k_0))
...
ax_errors = plt.subplot(122, sharex=ax_k)
