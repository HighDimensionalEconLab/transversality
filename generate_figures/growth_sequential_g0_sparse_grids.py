...
plt.plot(quant_result_g0_grid_1["k_t_approx"][quantiles["mid_quant"]], "black", label=r"$\hat{k}(t): \mathcal{X}_{train}^{Sparse~1}$")
plt.plot(quant_result_g0_grid_2["k_t_approx"][quantiles["mid_quant"]], "blue", label=r"$\hat{k}(t): \mathcal{X}_{train}^{Sparse~2}$")
...
plt.plot(quant_result_g0_grid_1["c_t_approx"][quantiles["mid_quant"]], "black", label=r"$\hat{c}(t): \mathcal{X}_{train}^{Sparse~1}$")
plt.plot(quant_result_g0_grid_2["c_t_approx"][quantiles["mid_quant"]], "blue", label=r"$\hat{c}(t): \mathcal{X}_{train}^{Sparse~2}$")
