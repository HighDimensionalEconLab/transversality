...
plt.plot(quant_result_g0_grid_2["k_t_approx"][quantiles["mid_quant"]], "gray", label=r"$k_\theta(t): \mathcal{D}^{Sparse~2}$, median")
plt.plot(quant_result_g0_grid_1["k_t_approx"][quantiles["mid_quant"]], "black", label=r"$k_\theta(t): \mathcal{D}^{Sparse~1}$, median")
...
plt.fill_between(t,quant_result_g0_grid_2["k_t_approx"][quantiles["low_quant"]],quant_result_g0_grid_2["k_t_approx"][quantiles["high_quant"]],facecolor="gray",alpha=0.4)
...
plt.plot(quant_result_g0_grid_2["c_t_approx"][quantiles["mid_quant"]], "lightblue", label=r"$c_\theta(t): \mathcal{D}^{Sparse~2}$, median")
plt.plot(quant_result_g0_grid_1["c_t_approx"][quantiles["mid_quant"]], "blue", label=r"$c_\theta(t): \mathcal{D}^{Sparse~1}$, median")
plt.fill_between(t,quant_result_g0_grid_1["c_t_approx"][quantiles["low_quant"]],quant_result_g0_grid_1["c_t_approx"][quantiles["high_quant"]],facecolor="blue",alpha=0.4)
plt.fill_between(t,quant_result_g0_grid_2["c_t_approx"][quantiles["low_quant"]],quant_result_g0_grid_2["c_t_approx"][quantiles["high_quant"]],facecolor="lightblue",alpha=0.4)
plt.axvline(x=max_T, color="k", linestyle="dashed")
...
axins.fill_between(t,quant_result_g0_grid_2["k_t_approx"][quantiles["low_quant"]],quant_result_g0_grid_2["k_t_approx"][quantiles["high_quant"]],facecolor="gray",alpha=0.3)
axins.plot(quant_result_g0_grid_2["k_t_approx"][quantiles["mid_quant"]], "gray")
