...
output_dir = "./figures"
plot_name = "growth_recursive_g0_multiple_steady_states_consumption_rel_error_ensemble"
...
ax_c_err_1 = plt.subplot(221)

plt.plot(
    k_1_quant_result_g0["t"],
    k_1_quant_result_g0["c_rel_error"][quantiles["mid_quant"]],
    "blue",
)
plt.fill_between(
    t,
    k_1_quant_result_g0["c_rel_error"][quantiles["low_quant"]],
    k_1_quant_result_g0["c_rel_error"][quantiles["high_quant"]],
    facecolor="blue",
    alpha=0.3,
)
...
plt.title(r"Relative error, $\varepsilon_c(t)$ for $k_0 = 0.4$")
plt.xlabel(r"Time($t$)")


ax_c_err_2 = plt.subplot(222, sharey = ax_c_err_1)

plt.plot(
    k_2_quant_result_g0["t"],
    k_2_quant_result_g0["c_rel_error"][quantiles["mid_quant"]],
    "blue",
)
plt.fill_between(
    t,
    k_2_quant_result_g0["c_rel_error"][quantiles["low_quant"]],
    k_2_quant_result_g0["c_rel_error"][quantiles["high_quant"]],
    facecolor="blue",
    alpha=0.3,
)
handles, labels = plt.gca().get_legend_handles_labels()
by_label = dict(zip(labels, handles))
#plt.legend(by_label.values(), by_label.keys(), prop={"size": params["font.size"]})
plt.title(r"Relative error, $\varepsilon_c(t)$ for $k_0 = 1.0$")
plt.xlabel(r"Time($t$)")


ax_c_err_3 = plt.subplot(223)

plt.plot(
    k_3_quant_result_g0["t"],
    k_3_quant_result_g0["c_rel_error"][quantiles["mid_quant"]],
    "blue",
)
plt.fill_between(
    t,
    k_3_quant_result_g0["c_rel_error"][quantiles["low_quant"]],
    k_3_quant_result_g0["c_rel_error"][quantiles["high_quant"]],
    facecolor="blue",
    alpha=0.3,
)
handles, labels = plt.gca().get_legend_handles_labels()
by_label = dict(zip(labels, handles))
#plt.legend(by_label.values(), by_label.keys(), prop={"size": params["font.size"]})
plt.title(r"Relative error, $\varepsilon_c(t)$ for $k_0 = 3.3$")
plt.xlabel(r"Time($t$)")

ax_k_err_4 = plt.subplot(224, sharey = ax_c_err_3 )

plt.plot(
    k_4_quant_result_g0["t"],
    k_4_quant_result_g0["c_rel_error"][quantiles["mid_quant"]],
    "blue",
)
plt.fill_between(
    t,
    k_4_quant_result_g0["c_rel_error"][quantiles["low_quant"]],
    k_4_quant_result_g0["c_rel_error"][quantiles["high_quant"]],
    facecolor="blue",
    alpha=0.3,
)
handles, labels = plt.gca().get_legend_handles_labels()
by_label = dict(zip(labels, handles))
#plt.legend(by_label.values(), by_label.keys(), prop={"size": params["font.size"]})
plt.title(r"Relative error, $\varepsilon_c(t)$ for $k_0 = 4.0$")
plt.xlabel(r"Time($t$)")
